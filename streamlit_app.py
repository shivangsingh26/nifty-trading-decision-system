"""
NIFTY Trading Decision System - Streamlit Dashboard
A modern, minimal web interface for trading predictions and analysis
"""
...
def get_available_models():
    ...
    for model_file in model_files:
        ...
        available_models[display_name] = os.path.join(models_dir, model_file)
...
def load_metrics():
    """Load model metrics"""
    try:
        metrics_path = 'output/metrics_report.txt'
...
def main():
    ...
    with st.sidebar:
        ...
        if available_models:
            ...
            st.info("Run `python main.py` to train models")
            selected_model_name = None
        ...
        st.markdown("**Features**: 20 selected indicators")
    ...
    with tab4:
        ...
        if metrics_content:
            ...
            with col4:
                st.metric("Training Samples", "21,070")
        ...
        with col1:
            ...
            3. Trade during opening session (optional)
            4. Prefer high volatility + trending markets
            """)
