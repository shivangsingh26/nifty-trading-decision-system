...
**Expected Performance**: ~52-55% accuracy
...
**Expected Performance**: ~54-58% accuracy
...
**Expected Performance**: ~56-60% accuracy

**Why LightGBM usually wins**:
...
|-------|------------------|-----------|
| Logistic Regression | 52-55% | Fast, interpretable baseline |
| Random Forest | 54-58% | Robust, handles non-linearity |
| **LightGBM** | **56-60%** | **Best overall, learns complex patterns** |

### Why LightGBM Typically Wins

**Technical Reasons**:
1. **Gradient Boosting**: Learns from errors iteratively vs Random Forest's independent trees
2. **Leaf-wise Growth**: More efficient tree building vs level-wise
3. **Feature Interactions**: Better captures complex relationships between indicators
4. **Regularization**: Built-in controls prevent overfitting

**Financial Data Reasons**:
1. Non-linear patterns in price movements
2. Complex interactions between technical indicators
3. Time-varying relationships (trends, volatility regimes)
4. Small signal-to-noise ratio requires sophisticated learning
...
**Problem**: If 60% UP, 40% DOWN → model may bias
**Solution**:
- Check class distribution first
- If severe (>70/30), use class weights
- Monitor precision/recall, not just accuracy

### Challenge 4: Low Baseline Accuracy
...
3. **Model Diversity**
   - Tested linear, bagging, and boosting approaches
   - LightGBM typically best for financial tabular data
